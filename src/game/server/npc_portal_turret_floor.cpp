...
// TL2 NOTE: This file is gonna have to be changed a lot to make sure we don't have errors when the player encounters the Portal Turret.
#include "cbase.h"
...
void CNPC_Portal_FloorTurret::ActiveThink(void)
{
	...
	// Obsolete code! Commented out for now.
...
void CNPC_Portal_FloorTurret::SearchThink(void)
{
	...
	if (pEnemy != NULL)
	{
		...
		// More obsolete code!! Commented out for now.
